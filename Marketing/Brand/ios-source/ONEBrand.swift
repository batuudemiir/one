...
public enum ONEBrand {
    ...
    /// Wordmark advance width ÷ square side. The glyphs overflow the square on purpose.
    ...
    /// Wordmark tracking, in em.
    public static let tracking: CGFloat = -0.07
    ...
    public static func display(_ size: CGFloat) -> Font {
        if UIFont(name: "Archivo_ExtraBold_Expanded", size: size) != nil {
            return .custom("Archivo_ExtraBold_Expanded", size: size)
        }
