...
public struct ONEAppMark: View {
    ...
    /// Point size whose "ONE" advance ≈ 1.22 × side for Archivo ExtraBold (wdth 118).
    /// (advance ≈ 2.572 em (incl. tracking) per the shipped metrics.)
    private var fontSize: CGFloat { side * ONEBrand.glyphWidthRatio / 2.572 }
